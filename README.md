...
3. js的数据类型,数据类型检测,优缺点   typeof null=='object'

4. js继承有哪些方式    es6和es5的继承的区别
...
2. 一个页面分左侧菜单,头部,内容区域,具体每块css怎么写

3. 清除浮动有哪些办法

4. BFC了解么,有什么作用,用来解决什么问题
...
2. webpack的loader和plugin的区别,有没有写过
...
5. babel的原理   jsx到ast的转化具体做了什么

6. babel将less转css具体怎么做的

7. 如果兼容ie10,babel需要怎么配置,
...
13. babel-component-plugin是什么

    https://juejin.cn/post/6844904077634060302

14. babel预设和plugin的区别
...
18. 谈谈组件api设计需要考虑哪些方面,目前用的框架有哪些符合开箱即用的思想,比如webpack

    https://www.jianshu.com/p/c8c092cf8f2f

19. 怎么通过ast过滤代码中的某些指定代码
...
4. node中setTimeout  setInterval和js中有什么区别   除这2种之外,还有什么方式做异步   nexttick
